	...
	public static void handleWelcomeScreenInput() {
		...
		do {
			try {
				...
				switch (input) {
				case 1:
					FileHandling.displayAllFiles("main");
					break;
				case 2:
					Class.handleFileMenuOptions();
					break;
				case 3:
		...
		do {
			try {
				...
				case 2:
					...
					FileHandling.createMainFolderIfNotPresent("main");
					List<String> filesToDelete = FileHandling.displayFileLocations(fileToDelete, "Main");
					...
					if (idx != 0) {
						FileHandling.deleteFile(filesToDelete.get(idx - 1));
					} else {
				...
				case 3:
					...
					FileHandling.createMainFolderIfNotPresent("Main");
					FileHandling.displayFileLocations(fileName, "Main");
